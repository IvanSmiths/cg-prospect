      ...
      <main className="terms-privacy">
        ...
        <section className="cnt-privacy cnt-t-p">
          ...
          <p className="small-font">
            ...
            automatically when using this Application. Unless specified
            ...
            the present document and in the Cookie Policy, if available. Users
            are responsible for any third-party Personal Data obtained,
          ...
          <ul className="list-term">
            ...
            <li className="small-font">
              ...
              information of commercial or promotional nature concerning this
              Application. Your email address might also be added to this list
              as a result of signing up to this Application or after making a
              purchase. Personal Data processed: email address. Contact form By
              filling in the contact form with their Data, the User authorizes
              this Application to use these details to reply to requests for
              information, quotes or any other kind of request as indicated by
              the form’s header. Personal Data processed: email address.
            </li>
            <li className="small-font">
              Donations <br />
